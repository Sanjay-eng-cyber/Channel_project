                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="slider">
                                ...
                                <ul class="list-unstyled comment-list">
                                    <li><a href="frontend/#"><i class="fa fa-heart"></i>27</a></li>
                                    <li><a href="frontend/#"><i class="fa fa-comments"></i>12</a></li>
                                    <li><a href="frontend/#"><i class="fa fa-share-alt"></i>14</a></li>
                            ...
                            <div class="detial-holder">
                                ...
                                <ul class="list-unstyled breadcrumbs">
                                    <li><a href="frontend/#">Chairs <i class="fa fa-angle-right"></i></a></li>
                                    <li>Products</li>
                                </ul>
                                ...
                                <div class="rank-rating">
                                    <ul class="list-unstyled rating-list">
                                        <li><a href="frontend/#"><i class="fa fa-star"></i></a></li>
                                        <li><a href="frontend/#"><i class="fa fa-star"></i></a></li>
                                        <li><a href="frontend/#"><i class="fa fa-star"></i></a></li>
                                        <li><a href="frontend/#"><i class="fa fa-star-o"></i></a></li>
                                    </ul>
                                    <span class="total-price">Reviews (12)</span>
                                </div><!-- Rank Rating of the Page end -->
                                <ul class="list-unstyled list">
                                    <li><a href="frontend/#"><i class="fa fa-share-alt"></i>SHARE</a></li>
                                    <li><a href="frontend/#"><i class="fa fa-exchange"></i>COMPARE</a></li>
                                    <li><a href="frontend/#"><i class="fa fa-heart"></i>ADD TO WISHLIST</a></li>
                                </ul>
                                <div class="txt-wrap">
