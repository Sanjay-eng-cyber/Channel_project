                ...
                <div class="col-12">
                    <div class="row d-flex justify-content-center">
                            <div class="col-md-6 col-lg-4 custom-boder">
                                <div class="py-5">
                                    <div class="mb-2">
                                        <img src="{{ 'frontend/images/svg/success-paymet.svg' }}" alt="" class="img-fluid mx-auto" style="width:250px">
                                    </div>
                                    <h5 class="text-center fw-500 mt-md-0 mt-3" style="color:#1EBA11"> Your Payment is Successful</h4>
