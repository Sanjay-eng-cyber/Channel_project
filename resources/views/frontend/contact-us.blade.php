                    ...
                    <h2 class="text-red main-head text-center mb-3">Contact US</h2>
                        <div class="row main-group-card p-2 p-sm-4 contact-img ">
                            ...
                            <div class="col-lg-5 py-2 isolation-contact position-relative">
                                ...
                                <img src="{{ asset('frontend/images/svg/first-circle-contact.svg') }}" alt="img" class="img-fluid circle-first-contact">

                                <img src="{{ asset('frontend/images/svg/second-circle-contact.svg') }}" alt="img" class="img-fluid circle-second-contact">
