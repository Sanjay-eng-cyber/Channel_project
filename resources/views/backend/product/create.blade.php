                        ...
                        <form class="mt-3" method="POST" action="{{ route('backend.product.store') }}"
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-xl-6  col-md-6 col-sm-12 mb-3">
                                   ...
                                   <textarea id="team-about" class="team-about" name="short_descriptions" rows="5" cols="50" class="form-control"minlength="3" maxlength="5000">{{old('short_descriptions')}}</textarea>
