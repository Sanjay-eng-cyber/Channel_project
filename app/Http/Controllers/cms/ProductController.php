...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'special_ingredients' => 'nullable|min:2|max:150',
            'care_instruction' => 'nullable|min:2|max:150',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'descriptions' => 'nullable|min:3|max:20000',
            'mrp' => 'required|numeric',
            'skin_type' => 'required|min:2|max:20',
            'material' => 'required|min:2|max:20',
            'special_ingredients' => 'required|min:2|max:150',
            'care_instruction' => 'required|min:2|max:150',
            'expiry' => 'required|min:2|max:20',
            'net_quantity' => 'required|min:2|max:20',
            'final_price' => 'required|numeric',
            'stock' => 'required|numeric',
